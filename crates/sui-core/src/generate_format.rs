...
fn get_registry() -> Result<Registry> {
    ...
    let multisig_pk =
        MultiSigPublicKey::new(vec![kp1.public(), kp2.public(), kp3.public()], vec![1, 1, 1], 2).unwrap();
    ...
    let multi_sig = MultiSig::combine(vec![sig1.clone(), sig2.clone(), sig3.clone()], multisig_pk).unwrap();
